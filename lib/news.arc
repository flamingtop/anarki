  ...
  `(tag html
     ...
     (tag body
       (center
         ...
         (pr "<a href="http://www.amazon.cn/gp/product/B005PKSR5U/ref=as_li_ss_tl?ie=UTF8&camp=536&creative=3132&creativeASIN=B005PKSR5U&linkCode=as2&tag=flamingtop-23"><img =\"20%\" src\"http://ec4.images-amazon.com/images/I/41gMLP11FbL.jpg\" /></a>")
         (pr "</p>")
